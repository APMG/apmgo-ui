...
export const AUDIO_META_DATA_LOADED: string = 'apmgo/audio-player/AUDIO_META_DATA_LOADED'
export const AUDIO_CAN_PLAY: string = 'apmgo/audio-player/AUDIO_CAN_PLAY'
export const PLAY_CLICK: string = 'apmgo/audio-player/PLAY_CLICK'
export const PAUSE_CLICK: string = 'apmgo/audio-player/PAUSE_CLICK'
export const MUTE_CLICK: string = 'apmgo/audio-player/MUTE_CLICK'
export const UNMUTE_CLICK: string = 'apmgo/audio-player/UNMUTE_CLICK'
export const VOLUME_CHANGE: string = 'apmgo/audio-player/VOLUME_CHANGE'
export const TIME_SCRUBBER_CHANGE: string = 'apmgo/audio-player/TIME_SCRUBBER_CHANGE'
export const CHANGE_TRACK: string = 'apmgo/audio-player/CHANGE_TRACK'
export const UPDATE_PLAYTIME: string = 'apmgo/audio-player/UPDATE_PLAYTIME'
export const TRACK_ENDED: string = 'apmgo/audio-player/TRACK_ENDED'
